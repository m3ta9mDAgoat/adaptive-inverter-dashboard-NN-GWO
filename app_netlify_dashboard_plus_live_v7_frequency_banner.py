...
def build_live_ui():
    with gr.Blocks(title="Adaptive Inverter — Live Interactive", css=LIVE_CSS) as live:
        gr.HTML("<div class='topnav'><a class='backlink' href='https://neural-network-gwo-adaptive-inverter.netlify.app/' target='_self'>← V16.10 Dashboard</a><b>Live Interactive</b></div>")
